...
{
public:
  virtual srslte::error_t setup_if_addr(uint32_t ip_addr, char *err_str, int slice_identifier) = 0;
};
...
public:
  ...
  virtual void      write_pdu(uint32_t lcid, srslte::byte_buffer_t *pdu, int slice_identifier) = 0;
...
public:
  ...
  virtual void enable_capabilities() = 0;
	virtual void slice_configured(int slice_id, uint8 ip_addr[]) = 0;
};
...
public:
  ...
  virtual void set_state(int state) = 0;
	virtual void set_sib1(LIBLTE_RRC_SYS_INFO_BLOCK_TYPE_1_STRUCT sib1) = 0;
	virtual LIBLTE_RRC_SYS_INFO_BLOCK_TYPE_1_STRUCT get_sib1() = 0;
};
...
{
public:
  virtual void write_sdu(int slice_id, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
};
...
public:
  ...
  virtual void write_sdu(int slice_id, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
	virtual void write_sdu_and_next_slice(int slice_id, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
  virtual void write_sdu_uecri(int slice_identifier, uint64_t uecri, uint32_t lcid, srslte::byte_buffer_t *sdu) = 0;
  virtual void add_bearer(int slice_id, uint32_t lcid, LIBLTE_RRC_PDCP_CONFIG_STRUCT *cnfg=NULL) = 0;
  virtual void config_security(int slice_id,
                               uint32_t lcid,
                               uint8_t *k_rrc_enc_,
                               uint8_t *k_rrc_int_,
  ...
  // gines
  virtual int get_current_slice() = 0;
  virtual void slice_configured(int slice_id, uint8 ip_addr[]) = 0;
  virtual void store_con_setup(srslte::byte_buffer_t *pdu) = 0;
};
...
public:
  ...
  virtual void write_pdu(uint32_t lcid, uint64_t slice_id, srslte::byte_buffer_t *sdu) = 0;
...
public:
  ...
  virtual void write_pdu(uint32_t lcid, uint64_t slice_id, uint8_t *payload, uint32_t nof_bytes) = 0;
...
public:
  ...
  virtual void set_contention_id(int slice_identifier, uint64_t uecri) = 0;
