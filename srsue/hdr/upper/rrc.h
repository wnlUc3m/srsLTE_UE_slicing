...
public:
  ...
  void liblte_rrc_log(char* str);
    ...
    // gines
  //void slice_configured();
  void set_state(int state);
	void set_sib1(LIBLTE_RRC_SYS_INFO_BLOCK_TYPE_1_STRUCT sib1);
  LIBLTE_RRC_SYS_INFO_BLOCK_TYPE_1_STRUCT get_sib1();
  int slice_identifier;
...
private:
  ...
  void enable_capabilities();
	void slice_configured(int slice_id, uint8 addr[]);
