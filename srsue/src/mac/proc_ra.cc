...
void ra_proc::init(phy_interface_mac* phy_h_, 
                   rrc_interface_mac *_rrc,
                   srslte::log* log_h_, 
                   mac_interface_rrc::ue_rnti_t *_rntis, 
                   ...
                   demux* demux_unit_)
{
  ...
  enum_rep[0] = "IDLE";
  enum_rep[1] = "INITIALIZATION";
  enum_rep[2] = "RES_SELECTION";
  enum_rep[3] = "PREAMBLE_TX";
  enum_rep[4] = "PDCCH_SETUP";
  enum_rep[5] = "RESPONSE_RECEPTION";
  enum_rep[6] = "RESPONSE_ERROR";
  enum_rep[7] = "BACKOFF_WAIT";
  enum_rep[8] = "CONTENTION_RESOLUTION";
  enum_rep[9] = "COMPLETION";
  enum_rep[10] = "COMPLETION_DONE";
  enum_rep[11] = "RA_PROBLEM";
...
bool ra_proc::contention_resolution_id_received(uint64_t rx_contention_id) {
  ...
  if (transmitted_contention_id == rx_contention_id){
    ...
    rInfo("Transmitted UE Contention Id differs from received Contention ID tx=%lu rx%lu\n",transmitted_contention_id, rx_contention_id);
    // Discard MAC PDU 
